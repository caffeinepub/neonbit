...
export const idlService = IDL.Service({
  ...
  'getTopHolders' : IDL.Func([IDL.Nat], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Nat))], ['query']),
  'getTotalMinted' : IDL.Func([], [IDL.Nat], ['query']),
  'getTransactionHistory' : IDL.Func([IDL.Principal], [IDL.Vec(Transaction)], ['query']),
  ...
  'updateCoinProfileAndMarketStats' : IDL.Func([CoinProfile, MarketStats], [], []),
